...
public class TranslateActivity extends AppCompatActivity {
   ...
   // String API_username = "ec849a7e-d480-4ee7-8139-03c9476fb437";
    //String API_password = "zR3ZaNaFuXLj";
    ...
    public void translateText(View v) throws UnsupportedEncodingException {
        TextView sourceTextView = (TextView) findViewById(R.id.txt_Email);

        sourceText = sourceTextView.getText().toString();
        System.out.println(sourceText);
       // sourceText = java.net.URLEncoder.encode(sourceText, "UTF-8").replace("+", "%20");
       // System.out.println(sourceText);

        String getURL = API_URL + sourceText;//The API service URL
            ...
            client.newCall(request).enqueue(new Callback() {
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    ...
                    try {
                        ...
                        System.out.println("Sentiment Type:" + Result2 + "-->" + "Score:" + Result1);
                        Log.d("okHttp", jsonResult.toString());
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                outputTextView.setText("Sentiment Type:  " + Result2 + "                 " + "          Score:   " + Result1);
                                System.out.println("Sentiment Type:" + Result2 + "  " + "Score:" + Result1);
                            }
                        });
